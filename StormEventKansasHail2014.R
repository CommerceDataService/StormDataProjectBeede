#This program downloads and unzips NOAA's Storm Event Database
#for 2014 and filters it to all events in (approximately) the state of Kansas

#Later I will adapt the following block of code so that the program really
#does download whatever years' worth of data I need:
#Note location of files: http://www1.ncdc.noaa.gov/pub/data/swdi/stormevents/csvfiles/
...
#unzip storm events data files
#later will run as a loop

gunzip("StormEvents_locations-ftp_v1.0_d2014_c20160223.csv.gz", 
       overwrite = TRUE, exdir=getwd)
gunzip("StormEvents_details-ftp_v1.0_d2014_c20160223.csv.gz",  
       overwrite = TRUE, exdir=getwd)
gunzip("StormEvents_fatalities-ftp_v1.0_d2014_c20160223.csv.gz",  
       overwrite = TRUE, exdir=getwd)

locations <- read.csv("StormEvents_locations-ftp_v1.0_d2014_c20160223.csv")
details <- read.csv("StormEvents_details-ftp_v1.0_d2014_c20160223.csv")
fatalities <- read.csv("StormEvents_fatalities-ftp_v1.0_d2014_c20160223.csv")
```
