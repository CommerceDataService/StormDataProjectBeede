###Program to download annual SWDI data on hail
...
for(yearly in c(2007:2015)){
  ...
  save(raw, file = paste("Nexrad_Hail_", yearly, ".rda", sep=""))
  ...
  save(raw, file = paste("Nexrad_Hail_Kansas", yearly, ".rda", sep=""))
}
